...
public final class SocksProxyServer {
    ...
    public void start() {
        networkServer = NetworkServer.tcpBind(new InetSocketAddress(0));
    ...
    private void handleClient(final NetworkEndpoint client) {
        ...
        try {
            ...
            final NetworkEndpoint toNetworkEndpoint = NetworkEndpoint.tcpConnect(new InetSocketAddress(inetAddress, port));
