...
import jayo.internal.RealAsyncTimeout.PriorityQueue
import jayo.internal.RealAsyncTimeout.TimeoutNode
...
class PriorityQueueTest {
    ...
    private fun String.toHeap(): PriorityQueue {
        ...
        assertThat(formattedBack).isEqualTo(this.trimMargin())

        return result
    }

    private operator fun PriorityQueue.get(value: Long): TimeoutNode {
        return array.single { it?.timeoutAt == TIME_UNIT.toNanos(value) }!!
    }
