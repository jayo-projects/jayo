...
object TestUtil {
    ...
    internal const val UTF8_REPLACEMENT_CODE_POINT: Int = Utf8Utils.UTF8_REPLACEMENT_CODE_POINT
    internal const val ASCII_REPLACEMENT_CODE_POINT: Int = Utf8Utils.ASCII_REPLACEMENT_CODE_POINT
...
//        assertEquals(b1.toString(), b2.toString())
        ...
        // Content.
        assertEquals(b1.bytesAvailable(), b2.bytesAvailable())
        val buffer = RealBuffer()
        b2.copyTo(buffer, 0, b2.bytesAvailable())
    ...
    fun newThread(task: Runnable): Thread {
        return JavaVersionUtils.threadFactory("JayoTests#").newThread(task)
    }
