...
public final class Utf8StringJavaTest {
    public static Stream<Arguments> parameters() {
        return Stream.of(
                Arguments.of(Utf8StringFactory.getUTF8_STRING(), "Utf8String"),
                Arguments.of(
                        Utf8StringFactory.getUTF8_STRING_FROM_BYTES(),
                        "Utf8String (from bytes)"),
                Arguments.of(
                        Utf8StringFactory.getUTF8_STRING_FROM_BYTES_NO_COMPACT_STRING(),
                        "Utf8String (from bytes without compact string)"),
                Arguments.of(Utf8StringFactory.getSEGMENTED_UTF8_STRING(), "SegmentedUtf8String"),
                Arguments.of(Utf8StringFactory.getUTF8_ONE_BYTE_PER_SEGMENT(),
    ...
    public void javaSerializationTestNonEmpty(Utf8StringFactory factory) {
        String bronzeHorseman = "На берегу пустынных волн";
        Utf8String byteString = factory.encodeUtf8(bronzeHorseman);
        assertEquivalent(byteString, TestUtil.reserialize(byteString));
    }

    @ParameterizedTest
    @MethodSource("parameters")
    public void startsWithString(Utf8StringFactory factory) {
        Utf8String byteString = factory.encodeUtf8("112233");
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    public void endsWithString(Utf8StringFactory factory) {
        Utf8String byteString = factory.encodeUtf8("112233");
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    public void indexOfString(Utf8StringFactory factory) {
        Utf8String byteString = factory.encodeUtf8("112233");
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    public void lastIndexOfString(Utf8StringFactory factory) {
        Utf8String byteString = factory.encodeUtf8("112233");
