...
/**
 * A {@link NetworkEndpoint} backed by an underlying {@linkplain java.net.Socket IO Socket}.
 */
public final class SocketNetworkEndpoint implements NetworkEndpoint {
    ...
    static @NonNull NetworkEndpoint connect(
            ...
            final @NonNegative int connectTimeoutMillis,
    ...
    public @NonNull RawReader getReader() {
        ...
        try {
            ...
            if (reader == null) {
                reader = //new SocketEndpointRawReader(this,
                        asyncTimeout.reader(new InputStreamRawReader(in), defaultReadTimeoutNanos);
    ...
    public @NonNull RawWriter getWriter() {
        ...
        try {
            ...
            if (writer == null) {
                writer = //new SocketEndpointRawWriter(this,
                        asyncTimeout.writer(new OutputStreamRawWriter(out), defaultWriteTimeoutNanos);
...
//    /**
//     * This raw reader respects Socket behavior regarding interrupted exceptions
//     */
//    private record SocketEndpointRawReader(@NonNull SocketNetworkEndpoint parent,
...
//
//    /**
//     * This raw writer respects Socket behavior regarding interrupted exceptions
//     */
//    private record SocketEndpointRawWriter(@NonNull SocketNetworkEndpoint parent,
