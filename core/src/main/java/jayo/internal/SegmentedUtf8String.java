...
import static jayo.internal.RealUtf8String.decodeToUtf8Static;
...
public final class SegmentedUtf8String extends SegmentedByteString implements Utf8String {
    public SegmentedUtf8String(final @NonNull Segment[] segments, final int @NonNull [] directory) {
        this(segments, directory, false);
    }

    private SegmentedUtf8String(final @NonNull Segment[] segments, final int @NonNull [] directory, final boolean isAscii) {
    ...
    public @NonNull Utf8String substring(int startIndex, int endIndex) {
        ...
        return new SegmentedUtf8String(newSegments, newDirectory, isAscii);
    }
     ...
     */
    @Override
    RealUtf8String toByteString() {
        return new RealUtf8String(toByteArray(), isAscii);
    }
