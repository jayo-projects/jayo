...
@file:JvmName("-Cancellable") // Leading '-' hides this class from Java.
 ...
 *
 * The provided timeout, if any, is used to set a deadline of now plus `timeout` time. This deadline will start when
