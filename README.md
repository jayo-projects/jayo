...
Jayo is a Multi-Release JAR with base Java version set to 17. Its Java 21 sources give access enhanced features like
internal use of virtual threads.
...
When used within Java 21+ virtual threads (see [Project Loom](https://openjdk.org/projects/loom/)), synchronous I/O in
fact use non-blocking network APIs. That's why Jayo offers great performances and scalability !
Virtual threads allow to run as many threads as we need without requiring thread pools or event-loop.
